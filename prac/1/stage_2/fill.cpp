...
public:
	...
	void get_matrices(Matrices *, bool, std::string);
};
...
void Graph::get_matrices(Matrices *obj, bool verbose = false, std::string output_file = "") {
...
int main(int argc, char *argv[]) {
	...
	A.get_matrices(&B, verbose, output_file);

	// FILL STAGE
	B.fill();
	//for (int i = 0; i < A.get_E(); i++) {
	//	cout << B.A[i] << " ";	
	//}
	//cout << "\n";
